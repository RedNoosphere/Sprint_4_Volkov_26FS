...
// Ждем и проверяем, что кнопка "Посмотреть статус" появилась
        String statusText = orderPage.waitForStatusButtonAndGetText();
        Assert.assertEquals("Посмотреть статус", statusText);
    }
